...
#define UNIVERSAL_HID_GAMEPAD_HOST_ENABLED 1
#define UNIVERSAL_HID_HUMAN_INTERFACE_HOST_ENABLED 1
#define UNIVERSAL_OUTPUT_ROUTER_ENABLED 1
#define OAG_BLUETOOTH_HOST_ENABLED 1
#define OAG_MULTI_XINPUT_ENABLED 1
#define OAG_PC_MULTI_HID_ENABLED 1
