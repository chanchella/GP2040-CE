...
manifest = {
    ...
    "features": {
        ...
        "u10i_rebased_directly_on_u10f_tree": True,
        "u10i_pairing_assist_window_ms": 30000,
        "u10i_pairing_assist_active_ble_scan": True,
        "u10i_pairing_assist_no_proactive_bond_delete": True,
        "u10i_btstack_pin_or_key_missing_repair_only": True,
        "u10i_wired_attach_detach_pairing_assist": True,
        "u10i_existing_bt_peers_untouched": True,
        "u10i_receiver_primary_km_frozen_from_u10f": True,
        "u10j_pairing_mode_preserved_from_u10i": True,
        "u10j_pairing_assist_on_usb_detach_only": True,
        "u10j_pairing_assist_scan_type": "passive",
        "u10j_pairing_assist_ble_only_window_ms": 30000,
        "u10j_u10f_usb_host_runtime_frozen": True,
        "u10j_u10f_keyboard_mouse_runtime_frozen": True,
        "u10j_wired_gamepad_mount_does_not_touch_bt_discovery": True,
        "u10k_missing_root_attach_recovery": True,
        "u10k_root_probe_period_ms": 250,
        "u10k_missing_root_stable_ms": 2000,
        "u10k_root_attach_retry_ms": 5000,
        "u10k_synthetic_root_remove_events": False,
        "u10k_root_dp_pins": [2, 4, 6],
        "u10k_usb_hub_support_frozen": True,
        "u10k_pairing_mode_frozen_from_u10j": True,
        "u10k_bluetooth_max_peers_frozen": 4,
        "u10k_bluetooth_primary_player1_frozen": True,
        "u10k_keyboard_mouse_follow_primary_frozen": True,
        "u10l_pio_config_source": "KNOWN_WORKING_3PORT_DIAGNOSTIC",
        "u10l_pio_tx_num": 1,
        "u10l_pio_sm_tx": 3,
        "u10l_pio_dma_tx_ch": 9,
        "u10l_pio_rx_num": 0,
        "u10l_pio_sm_rx": 2,
        "u10l_pio_sm_eop": 3,
        "u10l_root_dp_pins": [2, 4, 6],
        "u10l_failed_u10k_synthetic_attach_removed": True,
        "u10l_usb_hub_support_frozen": True,
        "u10l_pairing_mode_frozen_from_u10j": True,
        "u10l_bluetooth_max_peers_frozen": 4,
        "u10l_bluetooth_primary_player1_frozen": True,
        "u10l_keyboard_mouse_follow_primary_frozen": True,
        "u10l_supported_gamepad_pc_output_policy": "XBOX360_XINPUT_ONLY",
        "u10l_all_supported_gamepads_normalized_to_xbox360": True,
        "u10l_pc_generic_hid_gamepad_output": False,
        "u10l_pc_xinput_receiver_children": 4,
        "u10l_gamepad_output_policy_locked": True,
        "authentication": False,
    },
    "pc_xinput_profile": {
        "compatibility_vid": "0x045E",
        "compatibility_pid": "0x0719",
        "oag_strings": True,
    ...
    "verification": {
        ...
        "u10g_bluetooth_recovery": "REJECTED_LINK_ONLY_NO_HIDS",
        "u10h_bluetooth_recovery": "REJECTED_REBASED_TO_U10F",
        "u10i_pairing_mode_recovery": "HARDWARE_VERIFIED_BY_USER",
        "u10i_wired_pairing_assist": "NOT_SEPARATELY_VERIFIED",
        "u10i_u10f_regression": "FAILED_USB_HOST_PORTS_AND_GAMEPADS",
        "u10j_pairing_mode_preservation": "HARDWARE_VERIFIED_BY_USER",
        "u10j_three_usb_root_ports": "FAILED_PORT3",
        "u10j_wired_gamepads": "PARTIAL_HARDWARE",
        "u10j_keyboard_mouse_all_ports": "PARTIAL_P1_P2_ONLY",
        "u10k_pairing_mode_preservation": "PENDING_HARDWARE",
        "u10k_three_usb_root_ports": "FAILED_PORT3",
        "u10k_usb_hub": "PENDING_HARDWARE",
        "u10k_four_bluetooth_peers": "PENDING_HARDWARE",
        "u10k_primary_and_keyboard_mouse_routing": "PENDING_HARDWARE",
        "u10l_three_usb_root_ports": "PENDING_HARDWARE",
        "u10l_usb_hub": "PENDING_HARDWARE",
        "u10l_gamepad_xinput_output_policy": "PENDING_HARDWARE",
        "u10l_pairing_mode_preservation": "PENDING_HARDWARE",
        "u10l_four_bluetooth_peers": "PENDING_HARDWARE",
        "u10l_primary_and_keyboard_mouse_routing": "PENDING_HARDWARE",
    },
}
