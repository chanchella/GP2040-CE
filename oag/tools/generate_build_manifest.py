...
manifest = {
    ...
    "phase": "U10F-PM1-G3-BT-UNIVERSAL-INPUT",
    ...
    "features": {
        ...
        "bluetooth_peripheral_sm_policy": "PLATFORM_SC_BOND_NO_IO__INPUT_GOLDEN_BOND",
        "bluetooth_ctkd": False,
        "bluetooth_universal_input_merge": True,
        "bluetooth_output_gamepad_mode": "SINGLE_MERGED_GAMEPAD",
        "bluetooth_merge_all_gamepad_slots": True,
        "bluetooth_keyboard_mouse_as_gamepad": True,
        "bluetooth_axis_merge_policy": "MAX_ABSOLUTE_MAGNITUDE",
    ...
    "verification": {
        ...
        "u10f_pm1_xbox360_output_policy": "PENDING_HARDWARE",
    },
}
