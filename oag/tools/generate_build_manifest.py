...
manifest = {
    ...
    "phase": "U10F-PM1-UI5K-D1-DEFENSE-SQUARE-LOOP",
    ...
    "features": {
        ...
        "gamepad_defense_square_hold_combo": True,
        "gamepad_defense_square_trigger_ps": "SQUARE",
        "gamepad_defense_square_trigger_xbox": "X",
        "gamepad_defense_square_activation_ms": 1000,
        "gamepad_defense_square_cycle_ms": 400,
        "gamepad_defense_square_phases": [
            {"start_ms": 0, "end_ms": 80, "ps": "L2+R1", "xbox": "LT+RB"},
            {"start_ms": 80, "end_ms": 180, "ps": "L2", "xbox": "LT"},
            {"start_ms": 180, "end_ms": 250, "ps": "L2+CROSS", "xbox": "LT+A"},
            {"start_ms": 250, "end_ms": 280, "ps": "L2", "xbox": "LT"},
            {"start_ms": 280, "end_ms": 400, "ps": "CROSS", "xbox": "A"}
        ],
        "gamepad_defense_square_passthrough_before_activation": True,
        "gamepad_defense_square_release_immediate": True,
        "gamepad_defense_square_all_slots": True,
        "gamepad_defense_square_non_blocking": True,
    ...
    "verification": {
        ...
        "u10f_pm1_ui5k_d1_defense_square_loop": "PENDING_HARDWARE",
    },
}
