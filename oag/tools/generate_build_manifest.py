...
manifest = {
    ...
    "features": {
        ...
        "bluetooth_one_time_bond_migration": True,
        "bluetooth_classic_negative_pin": True,
        "bluetooth_peripheral_send_on_btstack_context": True,
        "bluetooth_classic_hid_host": True,
        "bluetooth_le_hog_host": True,
        "bluetooth_connection_budget": 6,
        ...
        "bluetooth_output_peripheral_runtime": True,
        "bluetooth_ble_hid_gamepad_advertising": True,
        "bluetooth_ble_hid_gamepad_name": "OAG Gamepad",
        "bluetooth_ble_hid_gamepad_slot0_runtime": True,
