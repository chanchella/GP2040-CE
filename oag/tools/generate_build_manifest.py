...
manifest = {
    ...
    "phase": "U10F-PM1-UI5E-STABLE-COMPOSITE-KM-2S",
    ...
    "features": {
        ...
        "usb_composite_single_configuration": True,
        "usb_composite_vid": "CAFE",
        "usb_composite_pid": "4015",
        "usb_composite_interface_count": 10,
        "usb_xusb_receiver_interfaces": 8,
        "usb_xusb_iad_grouped": True,
        "usb_xusb_ms_os_compatible_id": "XUSB20",
        "usb_mode_switch_reenumerates": False,
        "controllers_remain_enumerated_in_native_km_mode": True,
    ...
    "verification": {
        ...
        "u10f_pm1_ui5a_global_km_modes_pc_native": "PENDING_HARDWARE",
        "u10f_pm1_ui5b_global_km_hard_switch": "REJECTED_HARDWARE_BY_USER",
        "u10f_pm1_ui5c_global_km_logical_switch": "REJECTED_HARDWARE_BY_USER",
        "u10f_pm1_ui5d_dual_usb_persona_2s": "SUPERSEDED_BEFORE_HARDWARE",
        "u10f_pm1_ui5e_stable_composite_km_2s": "PENDING_HARDWARE",
    },
}
