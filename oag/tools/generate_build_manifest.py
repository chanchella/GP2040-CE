...
manifest = {
    ...
    "phase": "U10F-PM1-UI5K-C6-EFOOTBALL-TAP-HOLD-COMBOS",
    ...
    "features": {
        ...
        "gamepad_double_tap_window_ms": 300,
        "gamepad_triangle_gesture_combo": True,
        "gamepad_triangle_trigger_ps": "TRIANGLE",
        "gamepad_triangle_trigger_xbox": "Y",
        "gamepad_triangle_single_output_ps": "R2+TRIANGLE",
        "gamepad_triangle_single_output_xbox": "RT+Y",
        "gamepad_triangle_double_output_ps": "L1+R2+TRIANGLE",
        "gamepad_triangle_double_output_xbox": "LB+RT+Y",
        "gamepad_triangle_single_duration": "FIRST_PHYSICAL_TAP_DURATION",
        "gamepad_triangle_double_duration": "SECOND_PHYSICAL_PRESS_DURATION",
        "gamepad_triangle_all_slots": True,
        "gamepad_square_gesture_combo": True,
        "gamepad_square_trigger_ps": "SQUARE",
        "gamepad_square_trigger_xbox": "X",
        "gamepad_square_long_hold_activation_ms": 1000,
        "gamepad_square_long_hold_l2_held": True,
        "gamepad_square_long_hold_cross_on_ms": 200,
        "gamepad_square_long_hold_cross_off_ms": 500,
        "gamepad_square_long_hold_cross_cycle_ms": 700,
        "gamepad_square_long_hold_square_on_ms": 200,
        "gamepad_square_long_hold_square_off_ms": 1000,
        "gamepad_square_long_hold_square_cycle_ms": 1200,
        "gamepad_square_long_hold_release_immediate": True,
        "gamepad_square_double_tap_far_post": True,
        "gamepad_square_double_stick_angle_deg": 45,
        "gamepad_square_double_buttons_start_ms": 390,
        "gamepad_square_double_buttons_end_ms": 610,
        "gamepad_square_double_button_hold_ms": 220,
        "gamepad_square_double_stick_center_ms": 640,
        "gamepad_square_double_buttons_ps": "R2+SQUARE",
        "gamepad_square_double_buttons_xbox": "RT+X",
        "gamepad_square_far_post_direction_source": "OPPOSITE_CURRENT_HORIZONTAL_PRESERVE_VERTICAL",
        "gamepad_square_single_duration": "FIRST_PHYSICAL_TAP_DURATION",
        "gamepad_square_all_slots": True,
        "gamepad_r1_loop_combo": False,
        "gamepad_r1_passthrough_normal": True,
    ...
    "verification": {
        ...
        "hardware_verified_baseline_phase": "U10F-PM1-UI5K-WIN-XUSB20-4FUNC-KM-COMPOSITE-2S",
        "hardware_verified_baseline_sha": "01af260742a6a402a851cceef0707ae69bd6a301",
        ...
        "u10f_pm1_ui5k_c6_efootball_tap_hold_combos": "PENDING_HARDWARE",
    },
}
